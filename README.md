...
The copyrighted components of the HELFI can be attributed either by the citation to the HELFI (that contains the component attributions) or specifically, through these statements:
