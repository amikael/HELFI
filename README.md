...
* [The Nestel 1904 Greek New Testament with public domain lemmas and morphology](https://github.com/amikael/HELFI/Greek) -and with a column-oriented file format and token numbers for cross-lingual alignment
